...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    roundtableBackstage: "台下角色池",
    roundtableOnStage: "台上嘉宾",
    roundtableGoStage: "上台",
    roundtableOffStage: "下台",
    roundtableStageEmpty: "从台下邀请角色上台参与讨论",
  ...
  en: {
    ...
    roundtableBackstage: "Backstage",
    roundtableOnStage: "On Stage",
    roundtableGoStage: "On Stage",
    roundtableOffStage: "Off Stage",
    roundtableStageEmpty: "Invite roles from backstage to join the discussion",
