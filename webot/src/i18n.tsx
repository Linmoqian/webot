...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    heroSubtitle: "Yunfeng AI 拥有深度思考能力，能够洞察复杂问题。",
    settingsTitle: "设置",
    sectionModel: "模型设置",
    ...
    inputFooter: "Yunfeng AI 可能会犯错，请核实重要信息。",
    errorPrefix: "错误",
    ...
    roundtableCardsEmpty: "暂无角色卡片",
    roundtableFlipHint: "点击翻转",
    roundtableNoTrait: "暂无角色信息",
    roundtableTrash: "拖到这里删除",
    roundtableStart: "开始讨论",
    roundtableEmpty: "输入主题，邀请专家开始讨论",
    roundtableHistory: "讨论历史",
    roundtableNoHistory: "暂无讨论记录",
    roundtableDeleteRecord: "删除",
    roundtableCloseHistory: "关闭历史",
    edit: "编辑",
    delete: "删除",
    save: "保存",
    contextUninstall: "卸载",
  ...
  en: {
    ...
    heroSubtitle: "Yunfeng AI has deep thinking capabilities to understand complex problems.",
    ...
    inputFooter: "Yunfeng AI can make mistakes. Consider verifying critical information.",
    errorPrefix: "Error",
    ...
    roundtableCardsEmpty: "No role cards",
    roundtableFlipHint: "Click to flip",
    roundtableNoTrait: "No role details",
    roundtableTrash: "Drop here to delete",
    roundtableStart: "Start Discussion",
    roundtableEmpty: "Enter a topic and invite experts to discuss",
    roundtableHistory: "History",
    roundtableNoHistory: "No discussions yet",
    roundtableDeleteRecord: "Delete",
    roundtableCloseHistory: "Close History",
    edit: "Edit",
    delete: "Delete",
    save: "Save",
